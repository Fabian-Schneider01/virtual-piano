...
draw.top:			#draw the row with colorpiece
	...
	la a2, colors 		#load color array address
	draw.loop:
		lw t1, (a2)	#load elements of color array
...
play.song:
	...
	lw t1, 0(s3)	#load song address
	addi s3, s3, 4	#one position further with each iteration
	case.c:				
		li t5, 60
